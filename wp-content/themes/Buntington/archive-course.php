...
$cou_query = new WP_Query( array ( 'post_type' => 'course', 'order' => 'ASC', 'orderby' => 'title', 'paged' => $paged ) );
// sidebar
$sidebar_class = '';
				...
				<div class="row gutter"><!-- row -->
					...
					<div class="col-lg-12 col-md-12">
						...
						<table class="table table-striped table-courses"><!-- courses table -->
							...
							<?php while( $cou_query->have_posts() ) : $cou_query->the_post(); ?>
