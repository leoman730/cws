...
var iNettuts = {
    ...
    settings : {
        ...
        widgetDefault : {
            ...
            removable: true,
            collapsible: true,
            editable: false, /* PLEASE DO NOT EDIT THIS LINE */
    ...
    savePreferences : function () {
        ...
        $(settings.columns).each(function(i){
            ...
            $(settings.widgetSelector,this).each(function(i){
                ...
                cookieString += $('h1:eq(0)',this).text().replace(/\|/g,'[-PIPE-]').replace(/,/g,'[-COMMA-]') + ',';
    ...
    sortWidgets : function () {
        ...
        $(settings.columns).each(function(i){
            ...
            $(widgetData).each(function(){
                ...
                $(clonedWidget).find('h1:eq(0)').html(thisWidgetData[2].replace(/\[-PIPE-\]/g,'|').replace(/\[-COMMA-\]/g,','));
