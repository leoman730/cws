...
$options = array (
	...
	array( "name" => "nav-general",
		...
		array( "name" => "general-2",
			...
			array( "name" => "StumbleUpon ID",
				   "id" => $shortname."_stumbleupon_id",
				   "type" => "text",
				   "std" => "themejunkie",
				   "desc" => "desc",),		
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Show thumbnails on homepage",
                   "id" => $shortname."_show_home_thumb",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "desc. "),			   

			array( "name" => "Number of posts to show per widget",
				   "id" => $shortname."_column_post_num",
				   "type" => "text",
				   "std" => "5",
				   "desc" => "desc",),				   

			array( "name" => "Exclude categories from the column #1 widgets",
			...
			array( "name" => "Exclude categories from the column #2 widgets",
				   "id" => $shortname."_column2_cats",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "desc ",
				   "usefor" => "categories",
			...
			array( "name" => "Exclude categories from the column #3 widgets",
				   "id" => $shortname."_column3_cats",
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "desc ",
				   "usefor" => "categories",
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-advertisements",
		...
		array( "name" => "advertisements-1",
			...
			array( "name" => "Enable footer ad (728x90)",
